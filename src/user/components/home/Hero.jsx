...
const Hero = () => {
    ...
    return (
        <section className="relative bg-slate-950 text-purple-100 h-auto">
            ...
            {/* Hero content */}
            <div className="relative z-10 flex flex-col items-center justify-center text-center min-h-[100vh] px-6">
